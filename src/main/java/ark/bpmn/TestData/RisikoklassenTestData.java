...
public class RisikoklassenTestData {
	...
	public class models {
		...
		public static final String Dmn_01c__RKLForklaring = "./Dmn/01c__RKLForklaring.dmn";
		public static final String Dmn_01c_RKL2Forklaring = "./Dmn/01c_RKL2Forklaring.dmn";
	}
