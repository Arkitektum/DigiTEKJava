...
public class LedesystemModelTestData {
	public static final String IntegrationModelKey = "LedesystemSubModel";
	public static final String UserTaskId = "UserLedesystemSubModel";
	public static final String EndTaskId = "EndLedesystemSubModel";
	public static final String ModelKey = "LedesystemModel";

	public class models {
		public static final String BpmnSub_LedesystemModel = "LedesystemSubModel.bpmn";
